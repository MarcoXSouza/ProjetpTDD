...
public class CadastroDeUsuarioTestFalha2 {
	...
	public static void fechaNavegador() throws IOException, InterruptedException {
		String mensagem = driver.findElement(By.xpath("//*[@id=\"formCover\"]/div[1]/div[2]/sec-view[2]/div/label"))
				.getText();
		System.out.println(mensagem);
		Assert.assertTrue(mensagem.equals("Passwords do not match"), "Falha");
